...
.. code-block:: text
   ...
   ├── kubernetes
   │   ├── prod
   │   │   ├── app-prod-deployment-fast-api.yml
   │   │   ├── app-prod-deployment-redis.yml
   │   │   ├── app-prod-deployment-worker.yml
   │   │   ├── app-prod-ingress-fast-api.yml
   │   │   ├── app-prod-pvc-redis.yml
   │   │   ├── app-prod-service-fast-api.yml
   │   │   ├── app-prod-service-nodeport-fast-api.yml
   │   │   └── app-prod-service-redis.yml
   │   └── test
   │       ├── app-test-deployment-fast-api.yml
   │       ├── app-test-deployment-redis.yml
   │       ├── app-test-deployment-worker.yml
   │       ├── app-test-ingress-fast-api.yml
   │       ├── app-test-pvc-redis.yml
   │       ├── app-test-service-fast-api.yml
   │       ├── app-test-service-nodeport-fast-api.yml
