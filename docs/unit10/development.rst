...
1. A Fast API front end for accessing data and jobs functionality
...
the same container image for multiple functions (Fast API and Worker). We don't need a
...
1. Edit some source code (e.g. add a new Fast API route)
...
3. Runs a unit test or a curl command against fast api
