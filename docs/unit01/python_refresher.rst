...
Try this `Python 3 environment in a browser <https://www.online-python.com/>`_.
...
As your preferences change over time, so too can values stored in dictionaries:
...
.. code-block:: console
   ...
   [student-login]$ vim function_test.py
...
.. code-block:: console
   ...
   [student-login]$ python3 function_test.py
   Hello, world!
...
.. code-block:: console
   ...
   [student-login]$ pip3 install --user names
   Collecting names
...
* `Python3 environment in a browser <https://www.online-python.com/>`_
