...
that includes a Python program (using the FastAPI library) and a database. More recently, we added an additional
worker component. We have also discussed how we may want to start and stop multiple instances of some of these components
