...
First, use ``uv`` to install the ``requests`` library in your ``class-work`` project:

.. code-block:: console

   [coe332-vm]$ cd ~/class-work 
   [coe332-vm]$ uv add requests

  Resolved 35 packages in 402ms
  Prepared 4 packages in 58ms
